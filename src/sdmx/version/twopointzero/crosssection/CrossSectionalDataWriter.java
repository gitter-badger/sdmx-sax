...
public class CrossSectionalDataWriter {
    ...
    public static Document createDocument(DataDocument doc, Namespace namespace) {
        ...
        Element compactData = new Element("CrossSectionalData");
...
// Ignore Groups for now
        ...
        for (int i = 0; i < ds.getSeriesSize(); i++) {
            ...
            // A 'Series' in a cross sectional document is a 'Section'
            Element se = new Element("Section");
