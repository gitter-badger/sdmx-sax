 ...
 * @author James
 */
public class CategorySchemeMapReferenceType extends ChildObjectReferenceType {
    public CategorySchemeMapReferenceType(CategorySchemeMapRefType ref, anyURI uri){
        super(ref,uri);
    }
    public CategorySchemeMapReferenceType(anyURI uri){
        super(uri);
    }
}
