...
public class OrganisationSchemeReferenceBaseType extends ItemSchemeReferenceBaseType {
    public OrganisationSchemeReferenceBaseType(OrganisationSchemeRefBaseType ref,anyURI uri) {
        super(ref,uri);
    }
    public OrganisationSchemeReferenceBaseType(anyURI uri) {
        super(uri);
    }
