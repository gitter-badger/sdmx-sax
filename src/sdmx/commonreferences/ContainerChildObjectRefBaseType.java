 ...
 */
public class ContainerChildObjectRefBaseType extends RefBaseType {
    public ContainerChildObjectRefBaseType(NestedNCNameIDType agencyID,IDType maintParent,VersionType pvers,NestedIDType contId,NestedIDType id,ObjectTypeCodelistType obs,PackageTypeCodelistType pack) {
